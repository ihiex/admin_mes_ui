<template>
  <el-dialog class="label_dialog" width="50%" title="" :visible.sync="outerVisible" :show-close="false">
    ...
    <el-dialog class="inner_dialog" width="50%" title="" :visible.sync="innerVisible" append-to-body
      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <template v-else-if="flag === 2">
          <el-form-item label="函数" style="margin-bottom: 10px;">
            <!-- @change="handleFunctionChange" -->
            <el-select v-model="form.function" placeholder="函数" filterable @change="handleFnChange">
          ...
          <el-tree :data="list" node-key="id" default-expand-all
            ...
            <span slot-scope="{ node, data }" class="custom-tree-node">
              ...
              <span>
                ...
                <el-input v-else v-model="data.label" style="width: 100px;" @input="handleInput"></el-input>
              </span>
              <span class="tree_btn">
                <el-button v-if="data.isObj" type="primary" size="mini" circle @click="() => append(data, 1)">
                  <img src="./fx.svg" alt="" style="height: 12px;">
                </el-button>
                <el-button v-if="data.isObj" type="primary" size="mini" circle @click="() => append(data, 2)">
                  <img src="./params.svg" alt="" style="height: 12px;">
                </el-button>
                <el-button type="primary" size="mini" icon="el-icon-delete-solid" style="color: #222" circle
