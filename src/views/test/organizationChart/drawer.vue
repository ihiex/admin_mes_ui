  ...
  <el-drawer :title="$t('edit')" custom-class="demo-drawer" :visible.sync="drawer" direction="rtl" :append-to-body="true"
    ...
    <div class="drawer__content">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item :label="$t('职位')" prop="title">
...
export default {
  ...
  methods: {
    handleAvatarSuccess(res, file) {
      this.$set(this.ruleForm, 'pic', this.$baseUrl + res.ResData.FilePath)
    },
    show(data) {
    /*   console.log(this.$baseUrl)
      ...
      if (this.ruleForm.pic) {
        if(!this.ruleForm.pic.includes('api')){
          this.$set(this.ruleForm, 'pic', require("./images/HS" + this.ruleForm.pic))
        }
      } else {
