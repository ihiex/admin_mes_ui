      ...
      <el-tabs v-model="activeName" type="border-card">
        <el-tab-pane label="基本信息" name="first">
          ...
          <el-form-item label="访问域名" :label-width="formLabelWidth" prop="WebUrl">
            ...
            *域名授权请联系<span style="color: #415fff">SFC系统管理者</span>
          </el-form-item>
        ...
        <el-tab-pane label="功能权限" name="second">
          ...
          <el-form-item label="系统关闭原因" :label-width="formLabelWidth" prop="Webclosereason">
            <el-input v-model="editFrom.Webclosereason" type="textarea" placeholder="请输入系统关闭原因" autocomplete="off"
              clearable />
          </el-form-item>
          <el-form-item label="系统统计代码" :label-width="formLabelWidth" prop="Webcountcode">
            <el-input v-model="editFrom.Webcountcode" type="textarea" placeholder="请输入系统统计代码" autocomplete="off"
              clearable />
          </el-form-item>
        </el-tab-pane>
        ...
        <el-tab-pane label="邮件设置" name="four">
          ...
          <el-form-item label="邮箱密码" :label-width="formLabelWidth" prop="Emailpassword">
            <el-input v-model="editFrom.Emailpassword" placeholder="请输入邮箱密码" type="password" autocomplete="off"
              clearable />
          </el-form-item>
        ...
        <el-tab-pane label="文件上传" name="five">
          ...
          <el-form-item label="图片缩略大小" :label-width="formLabelWidth" prop="Thumbnailheight">
            宽<el-input v-model="editFrom.Thumbnailwidth" placeholder="缩略图宽度" autocomplete="off" style="width:150px;"
              clearable />px
            *高<el-input v-model="editFrom.Thumbnailheight" placeholder="缩略图高度" autocomplete="off" style="width:150px;"
              clearable />px
...
export default {
  ...
  data() {
    return {
      ...
      httpFileUploadUrl: `${this.$baseUrl}api/Files/Upload`, //defaultSettings.fileUploadUrl,
      dialogVisible: false,
      dialogImageUrl: '',
      filelist: [],
  ...
  created() {
    ...
    this.headers = { Authorization: this.$store.getters['user/accessToken'] }
  },
  methods: {
    ...
    uploadFileSuccess: function (response, file, fileList) {
      this.editFrom.SysLogo = this.$baseUrl + response.ResData.FilePath //defaultSettings.fileUrl + response.ResData.FilePath
    },
    saveEditForm() {
