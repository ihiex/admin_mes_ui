    ...
    <div class="left_container">
      ...
      <div class="over_station">
        <div class="input_data">
          ...
          <div v-if="isShowInfo" style="display: block">
              ...
              <div class="sn_container_left">
                <div>
                  <el-form ref="ruleForm" :model="query" :rules="rules" label-width="100px" class="demo-ruleForm" @submit.native.prevent>
                        ...
                        <div class="box_container">
                          ...
                          <div class="box_number">
                            <el-input ref="snInput" v-model.trim="childSN" autocomplete="off" :disabled="snDisabled"
                              clearable style="width: 70%" @keypress.native.enter="handleSNEnter(childSN)"></el-input>
                    ...
                    <!-- 参数 -->
                    <el-row v-if="operation" :gutter="10">
                      <el-col :span="24">
                        <div class="box_container">
                          <div class="box_title">
                            {{ $t("Parameter") }}
                          ...
                          <div class="box_number">
                            <el-col :lg="24" :xl="12">
                              <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12" style="margin-bottom: 5px">
...
export default {
  ...
  methods: {
    ...
    handleBoxSNEnter(val) {
      MainSnVerifyAsync(this.query).then(
        (res) => {
          try {
    ...
    handleSNEnter(val) {
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          ...
          ChildSnVerifyAsync(this.query).then(
            (res) => {
              try {
                if (res.Success && res.ResData) {
                  this.hintInfos.unshift({
