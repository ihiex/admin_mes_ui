                          ...
                          <el-form ref="ruleForm" :model="query" :rules="rules" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-row :gutter="0" style="margin: 0; padding: 0;">
                              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                                <el-form-item :label="$t('parameter1')" prop="ET">
                                  <el-input v-model.trim="query.ET" autocomplete="off" clearable ></el-input>
                                <!--   <el-select v-model="query.ET" placeholder="" style="width: 100%">
                              ...
                              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                                <el-form-item :label="$t('parameter2')" prop="SPAC">
                                  <el-input v-model.trim="query.SPAC" autocomplete="off" clearable ></el-input>
                                </el-form-item>
                              </el-col>
                            </el-row>
                            <el-form-item :label="$t('printCount')" prop="I_QTY">
...
export default {
  ...
  methods: {
    ...
    handleQueryReset() {
      ...
      this.$set(this.query, 'Type', 'FG_NPI')
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$confirm(this.$t('printConfirm'), this.$t('hint'), {
            ...
            .then(() => {
              this.$set(this.query, 'Type', 'FG_NPI')
              this.query.S_UnitStatus && delete this.query.S_UnitStatus
