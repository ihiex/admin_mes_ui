                        ...
                        <div class="form_box sidebar" style="flex-direction: column; margin: 0;">
                          ...
                          <el-form ref="ruleForm" :model="params" label-width="100px" class="demo-ruleForm">
                            <el-row :gutter="10" style="margin-top: 30px;">
                              ...
                              <el-col v-if="DOE_BuildNameEnabled" :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                                <el-form-item :label="$t('Build Name')" prop="DOE_BuildName">
                                  <el-select v-model="params.DOE_BuildName" placeholder="" style="width: 100%" clearable>
                                    <el-option v-for="item in buildNameOptions" :key="item" :label="item" :value="item">
                                    </el-option>
                                  </el-select>
                                </el-form-item>
                              </el-col>
                              <el-col v-if="DOE_CCCCEnabled" :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                                <el-form-item :label="$t('CCCC Config')" prop="CCCC">
                                  <el-input v-model.trim="params.CCCC" autocomplete="off"
                                    @input="handleCCCCInput"></el-input>
                                </el-form-item>
                              </el-col>
                              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
...
export default {
  ...
  data() {
    return {
      ...
      DOE_CCCCEnabled: false,
      DOE_BuildNameEnabled: false,
      Type: 'BatchToSN',
      params: {
        BatchNo: '',
        Type: 'BatchToSNDOE', //SmallBatch（大批次切小批次）BatchToSN(批次切SN) BatchToSNDOE(批次切SN DOE)
        RollNO: '',
        SpecQTY: null,
        UsageQTY: null,
        BatchQTY: null,
  ...
  methods: {
    handleCCCCInput(val) {
      this.$set(this.params, 'CCCC', val.slice(0, this.params.DOE_CCCC_Length))
    },
    ...
    handleQueryReset() {
      ...
      this.DOE_CCCCEnabled = false;
      this.DOE_BuildNameEnabled = false;
      // this.isLockBoxSN = true;
      // this.snDisabled = true;
      //清空录入信息相关
      Object.keys(this.params).forEach(key => {
        if (key === 'Type') {
          this.$set(this.params, key, 'BatchToSNDOE')
        ...
        } else if (typeof this.query[key] === 'boolean') {
    ...
    handleConfirm(query) {
      ...
      this.$set(params, 'Type', 'BatchToSNDOE');
      this.BOMtableData = [];
      this.craftTableData = [];
      this.completed = 0;
      this.target = 0;
        ...
        (res) => {
          try {
            ...
            if (res.Success && data) {
              ...
              this.DOE_CCCCEnabled = data.DOE_CCCCEnabled;
              this.DOE_BuildNameEnabled = data.DOE_BuildNameEnabled;
              ...
              this.buildNameOptions = data.List_DOE_BuildName ? [...data.List_DOE_BuildName] : []
              this.IsForceSplit = data.IsForceSplit


              this.$set(this.params, 'DOE_CCCCEnabled', data.DOE_CCCCEnabled)
              this.$set(this.params, 'DOE_BuildNameEnabled', data.DOE_BuildNameEnabled)
              this.$set(this.params, 'DOE_CCCC_Length', (data.DOE_CCCC_Length + "").length)
