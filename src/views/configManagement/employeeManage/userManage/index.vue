      ...
      <el-card>
        <el-form ref="searchform" :inline="true" :model="searchform" class="demo-form-inline" size="small">
          <el-form-item :label="$t('role')">
            <el-select v-model="searchform.RoleId" clearable filterable :placeholder="$t('pleaseSelect')" @change="handleSearch">
              <el-option v-for="item in selectRole" :key="item.Id" :label="item.FullName" :value="item.Id" />
            </el-select>
          </el-form-item>
          <el-form-item :label="$t('userInfo')">
            <el-input v-model.trim="searchform.Keywords" clearable :placeholder="$t('IDNameNicknamePhone')" @keyup.native.enter="handleSearch" @clear="handleSearch"/>
          </el-form-item>
    ...
    <el-card>
      ...
      <el-table ref="gridtable" v-loading="tableloading" :data="tableData" border stripe highlight-current-row
        ...
        <el-table-column prop="NickName" :label="$t('nickname')" sortable="custom" width="120" fixed
          show-overflow-tooltip />
        <el-table-column prop="Gender" :label="$t('gender')" sortable="custom" width="100" align="center">
        ...
        <el-table-column prop="Birthday" :label="$t('birthday')" sortable="custom" width="120" align="center"
          show-overflow-tooltip :formatter="dateformatter" />
        <el-table-column prop="MobilePhone" :label="$t('phoneNumber')" sortable="custom" width="150" align="center"
          show-overflow-tooltip />
        <el-table-column prop="EmailAddress" :label="$t('EmailAddress')" sortable="custom" width="150" align="center"
          show-overflow-tooltip />
        <el-table-column prop="DepartmentName" :label="$t('department')" sortable="custom" width="150" align="center"
          show-overflow-tooltip />
        <el-table-column prop="PermissionName" :label="$t('PermissionName')" sortable="custom" width="160" align="center"
          show-overflow-tooltip />
        <el-table-column prop="DepartmentName" :label="$t('NASA')" width="260" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
        ...
        <el-table-column prop="CreatorTime" :label="$t('addTime')" width="160" sortable show-overflow-tooltip />
        <el-table-column prop="LastModifyTime" :label="$t('updateTime')" width="160" sortable show-overflow-tooltip>
          <template slot-scope="scope">
    ...
    <el-dialog ref="dialogEditForm" :title="editFormTitle + ' ' + $t('user')" :visible.sync="dialogEditFormVisible"
      ...
      <el-form ref="editFrom" :inline="true" :model="editFrom" :rules="rules" class="demo-form-inline">
        ...
        <el-form-item :label="$t('UserType')" :label-width="formLabelWidth" prop="UserType">
          <el-select v-model="editFrom.UserType" clearable filterable :placeholder="$t('pleaseSelect')"
            style="width: 400px">
        ...
        <el-form-item :label="$t('role')" :label-width="formLabelWidth" prop="RoleId">
          <el-select v-model="editFrom.RoleId" multiple :reserve-keyword="true" clearable filterable
        ...
        <el-form-item :label="$t('EmployeeGroup')" :label-width="formLabelWidth" prop="EmployeeGroupID">
          <el-select v-model="editFrom.EmployeeGroupID" :reserve-keyword="true" clearable filterable
            :placeholder="$t('pleaseSelect')" style="width: 400px">
        ...
        <el-form-item :label="$t('status')" :label-width="formLabelWidth" prop="StatusID">
          <el-select v-model="editFrom.StatusID" :reserve-keyword="true" clearable filterable
            :placeholder="$t('pleaseSelect')" style="width: 400px">
        ...
        <el-form-item :label="$t('PermissionGroup')" :label-width="formLabelWidth" prop="PermissionId">
          <el-select v-model="editFrom.PermissionId" :reserve-keyword="true" clearable filterable
            :placeholder="$t('pleaseSelect')" style="width: 400px">
