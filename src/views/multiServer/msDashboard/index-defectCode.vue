<template>
  <div class="main_multiserver">
    <!--  <div v-show="showOutput" style="height: inherit;">
      <OutputDashboard ref="OutputDashboard" @completeOutputOnce="handleLastCarousel"></OutputDashboard>
    </div> -->
    <div v-loading="oneEvent">
      <div class="multiserver_title">
        ProjectName: {{ showOutput ? outputTitle : title[devServer[serverIndex - 1]] }}
      </div>
...
import { encryptedBase64, encryptedData, encryptedJSEncryptData, decryptedJSEncryptData } from '@/utils/encrypt.js'
