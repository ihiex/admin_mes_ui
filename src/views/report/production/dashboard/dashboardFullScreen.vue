<template>
  <el-dialog class="dashboardV1_full_page" title="" :visible.sync="dialogVisible" :fullscreen='true' :append-to-body="true" :show-close="true"
    ...
    <div style="position: absolute; right: 10px; top: 15px; z-index: 101; width: 30px; height: 30px; "
