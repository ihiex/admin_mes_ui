...
export function getData(data, levelValue = 3) {
  let dataList = HandleFormatDataIntegrate(
    ...
    HandleFormatData(data, levelValue, 'UPHTargetByHour').classifyItem,
    HandleFormatData(data, levelValue, 'YieldTarget').classifyItem,
  );
  return dataList
}
...
export function HandleFormatData(data = [], levelValue = 3, type = 'Output') {
  ...
  data[2].forEach(res => {
    ...
    listObj[key]['UPHTarget'] = res.UPHTarget ? res.UPHTarget : null;
    listObj[key]['YieldTarget'] = res.YieldTarget ? res.YieldTarget : null;
    listObj[key]['UPHTargetByHour'] = res.UPHTargetByHour ? res.UPHTargetByHour : null;
  ...
  Object.values(listObj).forEach(res => {
    ...
    if (tItem[key]) {
      ...
      tItem[key]['YieldTarget'] = res.YieldTarget;
      tItem[key]['UPHTargetByHour'] = res.UPHTargetByHour;
