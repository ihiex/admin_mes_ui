<template>
  <el-dialog class="dashboard_full_page" title="" :visible.sync="dialogVisible" :fullscreen='true' :append-to-body="true" :show-close="true"
  ...
  methods: {
    show() {
      ...
      this.$nextTick(function(){
        this.$refs.DashboardComponentF.start(true)
        this.$refs.DashboardComponentF.handleChartResize()
      })
    },
    close() {
      this.dialogVisible = false
      this.$emit('close')
      this.$refs.DashboardComponentF.handleClearTimer()
    },
    handleFullScreen() {
