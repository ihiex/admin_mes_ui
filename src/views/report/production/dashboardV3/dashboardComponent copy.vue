      ...
      <el-container class="container">
        ...
        <el-main class="main">
              ...
              <div class="main_top_left_top">
                <div class="select_box">
                  <el-select v-model="params.date" size="mini" placeholder="请选择"
                    style="width: 200px; margin-right: 5px;" @change="handleDateChange">
          ...
          <div class="main_bottom">
            <!-- <DefectByColor ref="DefectByColorRef" style="height: 100%" :cid="LineAndBarChart" /> -->
