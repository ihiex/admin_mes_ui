<template>
  <div class="page_container">
    <div class="query_bar">
      ...
      <div class="query_btn">
        <el-button v-hasPermi="['TT/WIPDetail/ExportData']" :icon="loading ? 'el-icon-loading' : ''" :disabled="loading" size="mini" @click="handleExport">
          {{ $t('export') }}
        </el-button>
    ...
    <div :class="{ table_content: !show, table_content_show: show }">
      <WIPDetailTable ref="WIPDetailTable" type="TTWIPList" />
    </div>
  </div>
</template>
