  ...
  <div class="page_container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column prop="Account" :label="$t('operatingAccount')" sortable="custom" width="120" />
        <el-table-column prop="NickName" :label="$t('operator')" sortable="custom" width="120" />
        <el-table-column prop="IPAddress" :label="$t('IPAddress')" sortable="custom" width="150" />
        <el-table-column prop="IPAddressName" :label="$t('IPCity')" sortable="custom" width="220" />
