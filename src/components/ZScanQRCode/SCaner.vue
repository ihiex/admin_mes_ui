<template>
  <div ref="scaner" class="scaner">
    ...
    <video v-show="showPlay" ref="video" class="source" :width="videoWH.width" :height="videoWH.height"
      controls></video>
    <canvas v-show="!showPlay" ref="canvas" style="height: 100%; width: 100%" />
    <!-- <button v-show="false" @click="run">开始</button> -->
  </div>
</template>
